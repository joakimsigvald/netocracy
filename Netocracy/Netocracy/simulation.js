...
function startSimulation() {
    ...
    simulationPane.html('Simulation started!');
    var connections = computeConnections();
    var tribes = computeTribes(connections);
    visualize(connections, tribes);
}

function visualize(connections, tribes) {
